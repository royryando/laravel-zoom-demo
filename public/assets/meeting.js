...
function websdkready() {
  ...
  let tmpArgs = {
      ...
      mn: document.querySelector('meta[name=meeting-id]').content,
      signature: document.querySelector('meta[name=signature]').content,
      pwd: document.querySelector('meta[name=password]').content,
  ...
  let meetingConfig = {
    ...
    leaveUrl: "/?result=meeting-finish",
